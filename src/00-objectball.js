...
function GameObject() {
    const team = {home:{teamName, colors, players}, away:{teamName, colors, players}}
    team.home.teamName = 'Brookln Nets'
    team.home.colors = ['black', 'white']
    team.home.players = {'Alan Anderson': {'number': 0, 'shoe': 16, 'points': 22, 'rebounds': 12, 'assist': 12, 'steals': 3, 'blocks': 1, 'slamDunks': 1},
